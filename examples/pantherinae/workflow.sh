...
smrt taxize --root_taxa $SUBFAMILY,$OUTGROUP 
...
# run *BEAST for each clade, 1 Million iterations is for testing
smrt cladeinfer --ngens=1_000_000 --sfreq=1000 --lfreq=1000
